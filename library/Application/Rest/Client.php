<?php
/**
 * Needs to rewrite the Zend_Rest_Client because it doesn't supports
 * or even overwrites the encrypt.
 * So the Application_Rest_Client supports
 * Content-type for PUT/POST requests 
 * 
 * Thanks for the idea from here:
 * @link http://framework.zend.com/issues/browse/ZF-6306?page=com.atlassian.jira.plugin.system.issuetabpanels%3Aall-tabpanel#issue-tabs
 *
...
class Application_Rest_Client extends Zend_Service_Abstract
{
    /**
     * Data for the query
     * @var array
     ...
     * @return Zend_Http_Response
     */
    final public function restPut($path, $data = null, $enctype = null)
    {
        $this->_prepareRest($path);
        return $this->_performPost('PUT', $data, $enctype);
    }
