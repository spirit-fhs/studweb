...
array(APPLICATION_PATH . '/../library', get_include_path())));
require_once 'Zend/Loader/Autoloader.php';
Zend_Loader_Autoloader::getInstance();
// Define some CLI options
$getopt = new Zend_Console_Getopt(
array('withdata|w' => 'Load database with sample data', 
...
if ('testing' != APPLICATION_ENV) {
    echo 'Writing Database Studweb in (control-c to cancel): ' . PHP_EOL;
    for ($x = 5; $x > 0; $x --) {
        echo $x . "\r";
        sleep(1);
    }
